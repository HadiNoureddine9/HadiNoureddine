...
const Certifications = () => {
    ...
    const getBadgeImageUrl = useMemo(() => (certName: string) => {
        ...
        <div className="py-20 w-full" id="certifications">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
                {certifications.map((cert, index) => {
                    ...
                    return (
                        <CertificationCard key={cert.id} cert={cert} badgeUrl={badgeUrl} index={index} />
                    );
                })}
            </div>

            <MLSpecializationCard />
        </div>
    );
};
...
MLSpecializationCard.displayName = 'MLSpecializationCard';
